        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-amber-200/80">100% Australian Owned & Operated</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Website Design", "Web Development", "SEO Optimization", "Digital Marketing"].map((service, index) => (
                <li key={index}>
                  <a
                    href="#"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              <a href="#" className="text-gray-500 hover:text-amber-300 transition-colors">
                Privacy Policy
              </a>
